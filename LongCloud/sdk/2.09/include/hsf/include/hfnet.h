...
int HSF_API hfnet_start_uart1(uint32_t uxpriority,hfnet_callback_t p_callback);

int HSF_API hfnet_start_uart1_ex(uint32_t uxpriority,hfnet_callback_t p_callback, int stack_size);
...
int HSF_IAPI hfnet_send_uart1_event(uint32_t event,void *data,uint32_t len,uint32_t buf_len);
